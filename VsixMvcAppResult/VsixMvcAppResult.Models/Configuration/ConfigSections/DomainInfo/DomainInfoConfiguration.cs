...
namespace VsixMvcAppResult.Models.Configuration.ConfigSections.DomainInfo
{
    ...
    public class DomainInfoConfiguration : IDomainInfoConfiguration
    {
        ...
        public string DomainName
        {
            get
            {
                //return VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.DomainInfoSettingsSection.DomainInfo.DomainName;
        ...
        public string SecurityProtocol
        {
            get
            {
                //return VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.DomainInfoSettingsSection.DomainInfo.SecurityProtocol;
                //DomainInfoSettingsConfigSection featuresSection = (DomainInfoSettingsConfigSection)System.Configuration.ConfigurationManager.GetSection("templateSettings/domainInfoSettings");
