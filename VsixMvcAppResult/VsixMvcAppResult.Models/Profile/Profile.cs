...
namespace VsixMvcAppResult.Models.Profile
{
    ...
    public class UserProfileModel : IUserProfileModel, IDisposable
    {
        ...
        public UserProfileModel(ProfileBase profileBase)
        {
            ...
            //                            :
            //                            VsixMvcAppResult.Models.Enumerations.CulturesAvailable.en_US;
        ...
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.FirstName)]
        [DataType(DataType.Text)]
        [DataMember]
        public string FirstName { get; set; }

        [Required(ErrorMessageResourceType = typeof(VsixMvcAppResult.Resources.General.GeneralTexts), ErrorMessageResourceName = GeneralTextsKeys.Required)]
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.LastName)]
        [DataType(DataType.Text)]
        [DataMember]
        public string LastName { get; set; }

        [Required(ErrorMessageResourceType = typeof(VsixMvcAppResult.Resources.General.GeneralTexts), ErrorMessageResourceName = GeneralTextsKeys.Required)]
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.BirtDate)]
        [DataType(DataType.Date)]
        [DataMember]
        public DateTime? BirthDate { get; set; }

        [Required(ErrorMessageResourceType = typeof(VsixMvcAppResult.Resources.General.GeneralTexts), ErrorMessageResourceName = GeneralTextsKeys.Required)]
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.Gender)]
        [DataMember]
        public Gender? Gender { get; set; }

        [Required(ErrorMessageResourceType = typeof(VsixMvcAppResult.Resources.General.GeneralTexts), ErrorMessageResourceName = GeneralTextsKeys.Required)]
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.Language)]
        ...
        [Required(ErrorMessageResourceType = typeof(VsixMvcAppResult.Resources.General.GeneralTexts), ErrorMessageResourceName = GeneralTextsKeys.Required)]
        [Display(ResourceType = typeof(VsixMvcAppResult.Resources.UserProfile.UserProfileTexts), Name = UserProfileTextsKeys.Theme)]
        [DataMember]
