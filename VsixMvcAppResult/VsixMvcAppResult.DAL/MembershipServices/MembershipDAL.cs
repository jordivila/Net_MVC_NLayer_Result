...
using VsixMvcAppResult.Models.Configuration.ConnectionProviders;
...
namespace VsixMvcAppResult.DAL.MembershipServices
{
    public class MembershipDAL : BaseDAL, IMembershipDAL
    {
        ...
        {
            Database db = DatabaseFactory.CreateDatabase(Info.GetDatabaseName(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.DatabaseNames.Membership));
