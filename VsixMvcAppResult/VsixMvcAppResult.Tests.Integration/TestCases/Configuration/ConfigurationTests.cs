...
namespace VsixMvcAppResult.Tests.Integration.TestCases.Configuration
{
    [TestClass]
    public class ConfigurationTests
    {
        ...
        {
            Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.WebSiteCommonScripts.Count > 0);
            Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.JQueryLibScripts.Count > 0);
            Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.WebSitePageInitScripts.Count > 0);

            //Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.JQueryLibGlobalizeLocalization.IndexOf("{0}")> -1);
            //Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.JQueryLibValidateLocalization.IndexOf("{0}") > -1);
            //Assert.IsTrue(VsixMvcAppResult.Models.Configuration.ApplicationConfiguration.ClientResourcesSettingsSection.JQueryLibUILocalization.IndexOf("{0}") > -1);
        }
    }
}
